...
<table id="tablegoods" class="easyui-datagrid" title="商品信息管理" style="width:700px;height:auto"
       data-options="
                fit:true,
                fitColumns:true,
				iconCls: 'icon-edit',
    ...
    <tr>
        ...
        <th data-options="field:'goodscategory',width:80,align:'center',editor:'textbox'">商品类别</th>
